...
import pl.jakubokrasa.bikeroutes.features.ui_features.myroutes.presentation.MyRoutesFragment
...
class GetSharedRoutesWithFilterUseCase (
    ...
    override suspend fun action(params: FilterData): List<Route>  {
        ...
        val routes = repository.getSharedRoutes(auth.getCurrentUserId()).toMutableList()
